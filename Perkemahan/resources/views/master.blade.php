...
<head>
    <meta charset="utf-8">
    <title>Fakhri Camp Website</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <!-- Favicon -->
    <link href="Kemah/img/favicon.ico" rel="icon">

    <!-- Google Web Fonts -->
    <link rel="preconnect" href="{{ url('https://fonts.googleapis.com'); }}">
    <link rel="preconnect" href="{{ url('https://fonts.gstatic.com'); }}" crossorigin>
    <link href="{{ url('https://fonts.googleapis.com/css2?family=Roboto:wght@400;500&family=Poppins:wght@600;700&display=swap'); }}" rel="stylesheet"> 
    ...
    <link href="{{ asset('Kemah/lib/animate/animate.min.css'); }}" rel="stylesheet">
    <link href="{{ asset('Kemah/lib/owlcarousel/assets/owl.carousel.min.css'); }}" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{ asset('Kemah/css/bootstrap.min.css'); }}" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="{{ asset('Kemah/css/style.css'); }}" rel="stylesheet">
</head>
...
<body>
    ...
    <!-- Navbar Start -->
    <nav class="navbar navbar-expand-lg bg-rgb(255, 166, 0) navbar-light sticky-top px-4 px-lg-5 py-lg-0" style="background-color: rgb(255, 166, 0);">
        <a href="index.html" class="navbar-brand d-flex align-items-center">
            <h1 class="m-0"><i class="fa fa-building text-primary me-3"></i>Fakhri Camp</h1>
        </a>
        <button type="button" class="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#navbarCollapse" style="color: whitesmoke"   >
            <span class="navbar-toggler-icon" style="color: whitesmoke"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-3 py-lg-0">
                <a href="index.html" class="nav-item nav-link active" style="color: rgb(54, 52, 52)">Home</a>
                <a href="about.html" class="nav-item nav-link" style="color: rgb(54, 52, 52)">Tentang Kami</a>
                <a href="service.html" class="nav-item nav-link" style="color: rgb(54, 52, 52)">Layanan Kami</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" style="color: rgb(54, 52, 52)">Pages</a>
                    <div class="dropdown-menu bg-light m-0">
                        <a href="feature.html" class="dropdown-item" style="color: rgb(54, 52, 52)">Features</a>
                        <a href="appointment.html" class="dropdown-item" style="color: rgb(54, 52, 52)">Appointment</a>
                        <a href="testimonial.html" class="dropdown-item" style="color: rgb(54, 52, 52)">Testimonial</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="Kemah/img/slide-2.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-12 col-lg-10">
        ...
        <div class="row g-0">
            <div class="col-xl-3 col-sm-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="position-relative">
                    <img class="img-fluid w-100" src="Kemah/img/fact-1.jpg" alt="">
            ...
            <div class="col-xl-3 col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                <div class="position-relative">
                    <img class="img-fluid w-100" src="Kemah/img/fact-2.jpg" alt="">
                    <div class="facts-overlay">
            ...
            <div class="col-xl-3 col-sm-6 wow fadeIn" data-wow-delay="0.5s">
                <div class="position-relative">
                    <img class="img-fluid w-100" src="Kemah/img/fact-3.jpg" alt="">
                    <div class="facts-overlay">
            ...
            <div class="col-xl-3 col-sm-6 wow fadeIn" data-wow-delay="0.7s">
                <div class="position-relative">
                    <img class="img-fluid w-100" src="Kemah/img/fact-4.jpg" alt="">
                    <div class="facts-overlay">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-light overflow-hidden h-100">
                        <img class="img-fluid" src="Kemah/img/service-1.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-light overflow-hidden h-100">
                        <img class="img-fluid" src="Kemah/img/service-2.jpg" alt="">
                        <div class="service-text position-relative text-center h-100 p-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-light overflow-hidden h-100">
                        <img class="img-fluid" src="Kemah/img/service-3.jpg" alt="">
                        <div class="service-text position-relative text-center h-100 p-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-light overflow-hidden h-100">
                        <img class="img-fluid" src="Kemah/img/service-4.jpg" alt="">
                        <div class="service-text position-relative text-center h-100 p-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-light overflow-hidden h-100">
                        <img class="img-fluid" src="Kemah/img/service-5.jpg" alt="">
                        <div class="service-text position-relative text-center h-100 p-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-light overflow-hidden h-100">
                        <img class="img-fluid" src="Kemah/img/service-6.jpg" alt="">
                        <div class="service-text position-relative text-center h-100 p-4">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item position-relative">
                        <img class="img-fluid" src="Kemah/img/team-1.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item position-relative">
                        <img class="img-fluid" src="Kemah/img/team-2.jpg" alt="">
                        <div class="team-text bg-white p-4">
                            <h5>Full Name</h5>
                            <span>Engineer</span>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item position-relative">
                        <img class="img-fluid" src="Kemah/img/team-3.jpg" alt="">
                        <div class="team-text bg-white p-4">
                            <h5>Full Name</h5>
                            <span>Engineer</span>
                        </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="owl-carousel testimonial-carousel">
                        ...
                        <div class="testimonial-item">
                            <img class="img-fluid mb-4" src="Kemah/img/testimonial-2.jpg" alt="">
                            <p class="fs-5">Dolores sed duo clita tempor justo dolor et stet lorem kasd labore dolore lorem ipsum. At lorem lorem magna ut et, nonumy et labore et tempor diam tempor erat.</p>
                            <div class="bg-primary mb-3" style="width: 60px; height: 5px"></div>
                            <h5>Client Name</h5>
                            <span>Profession</span>
    ...
    <script src="{{ asset('Kemah/lib/wow/wow.min.js'); }}"></script>
    <script src="{{ asset('Kemah/lib/easing/easing.min.js'); }}"></script>
    <script src="{{ asset('Kemah/lib/waypoints/waypoints.min.js'); }}"></script>
    <script src="{{ asset('Kemah/lib/owlcarousel/owl.carousel.min.js'); }}"></script>

    <!-- Template Javascript -->
    <script src="{{ asset('Kemah/js/main.js'); }}"></script>
</body>
