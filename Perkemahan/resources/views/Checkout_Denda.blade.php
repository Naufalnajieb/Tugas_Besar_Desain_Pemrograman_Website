...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-4 text-white animated slideInDown mb-4">Membayar Denda kerusakan</h1>
    ...
    <div class="d-flex justify-content-center">
        <div class="card">
            <div class="card-body text-center d-flex flex-column justify-content-center align-items-center">
                Anda akan membayar denda kerusakan produk <strong>{{ $items->nama }}</strong> dengan biaya
                <strong>Rp{{ number_format($items->denda_kerusakan, 0, ',', '.') }}</strong>
    ...
    <script type="text/javascript">
        ...
        snap.pay('{{$sql->snap_token}}', {
          ...
          onSuccess: function(result){
            window.location.href = "{{ url('/Checkout/success_pengembalian/' . $sql->id_pengembalian) }}";
          },
          // Optional
