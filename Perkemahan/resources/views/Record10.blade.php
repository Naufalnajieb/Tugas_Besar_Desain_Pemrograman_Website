...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-4 text-white animated slideInDown mb-4">Record 10 Transaksi Terbesar di Fakhri Camp</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="{{ url('/dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">
                        <a href="">Record 10 Transaksi Terbesar di Fakhri Camp</a>
                    </li>
                </ol>
            </nav>
        </div>
     ...
     <section id="rekam_medis" class="services">
        <div class="container">
          ...
          <div class="section-title">
            <h2>Record 10 Transaksi Terbesar di Fakhri Camp</h2>
